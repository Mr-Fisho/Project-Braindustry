...
class ModDefense implements ContentList {
    ...
    public void load() {
        rapier = new ItemTurret("rapier") {{
            ...
            description = "Shots frag bullets.";
            range = 200;
            reloadTime = 80;
            size = 4;
            shots = 1;
...
//                    ModItems.exoticAlloy, ModBullets.heavyMethaneShot,
        ...
        neuron = new ItemTurret("neuron") {{
            ...
            description = "A small turret that fires lasers that do splash damage. Requires power aswell as Graphenite to shoot.";
        ...
        shinigami = new ItemTurret("shinigami") {{
            ...
            requirements(Category.turret, ItemStack.with(ModItems.graphenite, 2900, Items.metaglass, 1000, ModItems.exoAlloy, 800, Items.plastanium, 700, Items.silicon, 2500));
            ammo(
        ...
        exoticAlloyWallLarge = new Wall("dense-composite-wall-large") {{
            ...
            description = "A bigger Dense Composite Wall, creates lighting when shot.";
            health = 4160;
            size = 2;
        ...
        exoticAlloyWall = new Wall("dense-composite-wall") {{
            ...
            description = "An Dense Composite Wall, creates lightning when shot.";
            health = 1270;
            size = 1;
        ...
        grapheniteWall = new Wall("graphenite-wall") {{
            ...
            description = "A purple, a high tech wall.";
            size = 1;
            health = 670;
        ...
        odinumWall = new Wall("odinum-wall") {{
            ...
            description = "Medium strength wall, a strong wall but little radioactive.";
            size = 1;
            health = 720;
        ...
        plasticWall = new Wall("plastic-wall") {{
            ...
            description = "A sturdy wall that can deflect some bullets.";
            health = 1080;
            size = 1;
